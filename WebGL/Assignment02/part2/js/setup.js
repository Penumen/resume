...
function setup() {
    ...
    const floorDiff = new THREE.TextureLoader().load('images/c_floor_diff.jpg');
    // Ambient occlusion map
    const floorAo = new THREE.TextureLoader().load('images/c_floor_ao.jpg');
    // Displacement map
    const floorDisp = new THREE.TextureLoader().load('images/c_floor_disp.png');
    // Normal map
    const floorNorm = new THREE.TextureLoader().load('images/c_floor_nor.jpg');
    // Roughness map
    const floorRoughness = new THREE.TextureLoader().load('images/c_floor_rough.jpg');
    // Metallic map
    const floorMetal = new THREE.TextureLoader().load('images/c_floor_metal.jpg');
